"""
Tests for plugin/scripts/render_threat_model.py (Step 1 of the template migration).
...
Covers:
  ...
  - template skeleton under plugin/templates/ is well-formed
"""
...
TEMPLATE_PATH  = REPO_ROOT / "plugin" / "templates" / "threat-model.template.md"
FIXTURES_DIR   = Path(__file__).parent / "fixtures" / "render"


def _load_module(name: str, path: Path):
    """Load a standalone .py file as a module (plugin/scripts/ is not a package)."""
