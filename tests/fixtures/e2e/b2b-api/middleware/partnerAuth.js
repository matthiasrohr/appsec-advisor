// B2B partner authentication middleware
// Partners authenticate with their assigned partner API key
module.exports = (req, res, next) => {
  ...
  // Validate partner key against database
  const partner = db.partners.findByApiKey(partnerApiKey)
