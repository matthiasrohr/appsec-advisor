...
| Wall clock (active) | 83m 19s |
| Agent compute (Σ parallel dispatches) | 98m 06s |
...
| Phase 11 | [§7](#7-security-architecture) enrichment complete (secarch role) | threat-analyst (sonnet-4-6) | 6m 25s |
