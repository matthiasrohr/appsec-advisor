...
Fixtures defined here:
    ...
    run_plugin_script    — subprocess.run wrapper for any plugin/scripts/*.py
...
def plugin_root() -> Path:
    """Absolute Path to appsec-plugin/plugin/.
...
# ---------------------------------------------------------------------------
# run_plugin_script — subprocess wrapper for plugin/scripts/*.py
# ---------------------------------------------------------------------------
@pytest.fixture
def run_plugin_script() -> Callable[..., subprocess.CompletedProcess[str]]:
    """Run a script under plugin/scripts/ as a subprocess.
    ...
    Arguments:
        script_name : file name under plugin/scripts/ (e.g. "plugin_meta.py").
