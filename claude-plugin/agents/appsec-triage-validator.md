...
Verify each threat's `cvss_v4` field against the eligibility rules encoded in `claude-plugin/data/cvss-eligible-cwes.yaml`. Read the positive list once at the start of this step.
