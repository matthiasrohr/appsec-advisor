...
**Files:**
- Modify: `claude-plugin/agents/phases/phase-group-finalization.md:28-31`

- [ ] **Step 1: Add `run_statistics` block to YAML schema**

In `claude-plugin/agents/phases/phase-group-finalization.md`, replace lines 28-31 (from `analysis_duration_seconds` through `recommend_full_rerun` closing comment) with the expanded schema that includes `run_statistics`:
...
git add claude-plugin/agents/phases/phase-group-finalization.md
...
**Files:**
- Modify: `claude-plugin/agents/phases/phase-group-finalization.md:444-543`
...
**Files:**
- Modify: `claude-plugin/agents/appsec-qa-reviewer.md:989-1031`
...
```bash
cd /home/mrohr/appsec-plugin
git add claude-plugin/agents/appsec-qa-reviewer.md
...
**Files:**
- Modify: `claude-plugin/skills/create-threat-model/SKILL.md:530-633`
...
```bash
cd /home/mrohr/appsec-plugin
git add claude-plugin/skills/create-threat-model/SKILL.md
...
CLAUDE_PLUGIN_ROOT="/home/mrohr/appsec-plugin/claude-plugin"
