Invoke the `appsec-threat-analyst` agent to perform a full STRIDE-based threat assessment of the current repository and write the results to `THREAT_MODEL.md`.
